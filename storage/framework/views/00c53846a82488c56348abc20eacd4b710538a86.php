...
<head>
   ...
   table{
		...
		<div class="ul">
            ...
            <li><a class="active" href="/form.blade">Form</a></li>			</div>
...
<table>
	<tr>
		<td>
			<img src="<?php echo e(URL::asset('img/nory8.png')); ?>" style=" border-radius:30px; border:10px ; " >
