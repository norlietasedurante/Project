...
<body>
		<div class="logo">
				<img src=" <?php echo e(URL::asset('img/nory13.png')); ?>" width="50%" >	
		</div>
...
<div class="main">
	...
	<form method="POST" action="/update">
		...
		<input type="hidden" name="Age" value="<?php echo e($student->Age); ?>">
		<input type="hidden" name="Address" value="<?php echo e($student->Address); ?>">
		<input type="hidden" name="Guardian" value="<?php echo e($student->Guardian); ?>">
